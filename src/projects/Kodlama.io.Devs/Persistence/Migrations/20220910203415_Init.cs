    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GithubSocials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GithubSocials_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.InsertData(
                table: "Technologies",
                columns: new[] { "Id", "IsActive", "Name", "ProgrammingLanguageId" },
                values: new object[] { 2, true, "ASP.NET", 1 });

            migrationBuilder.InsertData(
                table: "Technologies",
                columns: new[] { "Id", "IsActive", "Name", "ProgrammingLanguageId" },
                values: new object[] { 3, true, "JSP", 2 });

            migrationBuilder.CreateIndex(
                name: "IX_GithubSocials_UserId",
                table: "GithubSocials",
                column: "UserId");
